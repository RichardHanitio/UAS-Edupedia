...
<body>
    ...
    <div class="profile-container">
        <div class="profile-picture"><img src="./Image/" alt=""></div>
        <div class="profile-name">Aveline</div>
        ...
        <div class="info-container general">
            ...
            <div class="general-container">
                <div class="info">
                    ...
                    <div class="value" id="name">Aveline</div>
                </div>

                <div class="info">
                    <div class="title">Birthday</div>
                    <div class="value" id="birthday">17 December 2005</div>
                </div>

                <div class="info">
                    <div class="title">Zodiac</div>
                    <div class="value" id="zodiac">
                        <img src="./Zodiac/aries.png" alt="">
                    </div>
                </div>

                <div class="info">
                    <div class="title">Gender</div>
                    <div class="value" id="gender">Woman</div>
                </div>

                <div class="info">
                    <div class="title">Location</div>
                    <div class="value" id="location">Indonesia</div>
                </div>
    ...
    <div class="content">aaaaa</div>
    <div class="content">aaaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aaBaaa</div>
    <div class="content">aCCaaa</div>
